...
- 广州市绘天信息科技有限公司 技术负责人(CTO) (2015-12 ~ 2022-10)
...
- 广东省三线一单智慧管控项目
  ...
  **软件环境** Spring 全家桶 (Boot, Mvc, Security), MyBatis/MyBatis Plus, PostgreSQL/PostGIS, .NET 5, Docker, Ubuntu
  ...
  **项目描述**
  ...
  - **成果综合管理子系统** 包括资成果信息综合管理、领导导航仓、源目录管理以及标准服务接口 (WFS、 矢量切片) 开发四个模块；
  - **环评决策支持子系统** 基于矢量空间分析、遥感影像解译、大数据分析等手段对成果数据实现环评决策支持功能，智能分析、校验建设项目环评审批的可行性，辅助管理人员对建设项目进行科学、全面、高效的决策；
  - **成果监管分析子系统** 充分利用移动互联网和智能手机的广泛应用，将“三线一单”成果可视化展示、环评决策支持等功能延伸到移动端，便于用户通过移动端（粤政易）即可了解掌握“三线一单”成果，并进行相关分析与现场验证；
...
- 土壤预警平台
  ...
  **软件环境** Spring 全家桶 (Boot, Mvc, Security), MyBatis/MyBatis Plus, PostgreSQL/PostGIS, Docker, Ubuntu
